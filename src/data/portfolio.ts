...
export const fallbackSite: SiteData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: {
        skills: [
          { id: 1, name: "HTML", category: "Frontend",icon:null },
          { id: 2, name: "CSS", category: "Frontend",icon:null },
          { id: 3, name: "JavaScript", category: "Frontend",icon:null },
          { id: 4, name: "React", category: "Frontend",icon:null },
          { id: 5, name: "SASS / SCSS", category: "Frontend",icon:null },
          { id: 6, name: "Bootstrap", category: "Frontend",icon:null },
          { id: 7, name: "Tailwind", category: "Frontend",icon:null },
          { id: 8, name: "Twig", category: "Frontend / Templates",icon:null },
          { id: 9, name: "PHP", category: "Backend",icon:null },
          { id: 10, name: "Python", category: "Backend",icon:null },
          { id: 11, name: "Django", category: "Backend",icon:null },
          { id: 12, name: "WordPress", category: "CMS",icon:null },
          { id: 13, name: "Drupal", category: "CMS",icon:null },
          { id: 14, name: "Git", category: "Herramientas",icon:null },
          { id: 15, name: "GitHub", category: "Herramientas",icon:null },
          { id: 16, name: "MySQL", category: "Bases de datos",icon:null },
          { id: 17, name: "phpMyAdmin", category: "Bases de datos",icon:null },
        ],
      },
    },
    {
